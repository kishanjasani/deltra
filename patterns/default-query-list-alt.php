<?php
/**
 * Title: Default posts list - Alt
 * Slug: deltra/default-query-list-alt
 * Categories: query
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large"}}},"backgroundColor":"contrast","textColor":"base","layout":{"type":"constrained"},"metadata":{"name":"Default posts list - Alt"}} -->
		...
		<!-- wp:post-template -->
			...
			<div class="wp-block-columns" style="border-bottom-color:var(--wp--preset--color--accent-4);border-bottom-width:1px;margin-bottom:0;padding-top:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--small)">
				...
				<div class="wp-block-column" style="flex-basis:80%">
					<!-- wp:post-title {"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|base"},":hover":{"color":{"text":"var:preset|color|accent-2"}}}},"spacing":{"margin":{"top":"0"}}},"textColor":"base","fontSize":"medium"} /-->
				</div>
				<!-- /wp:column -->

				<!-- wp:column {"verticalAlignment":"top","width":"20%"} -->
				<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:20%">
					<!-- wp:post-date {"textAlign":"right","style":{"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"0","bottom":"0"}}},"textColor":"accent-6","className":"align-left-mobile","fontSize":"x-small"} /-->
				</div>
				<!-- /wp:column -->
			</div>
			<!-- /wp:columns -->
