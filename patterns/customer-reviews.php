 ...
 * Slug: deltra/customer-reviews
 * Categories: featured
 * Description: Display customer rating with stars, avatars, and review count for social proof.
 * Viewport Width: 1400
 *
 * @package    deltra
 */
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large"}}},"layout":{"type":"constrained"},"metadata":{"name":"Customer Reviews"}} -->
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large)"><!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
