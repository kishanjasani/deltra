<?php
/**
 * Title: Voice of Customers - Grid
 * Slug: deltra/voice-of-customers-grid
 * Categories: testimonials
 * Description: A testimonials section with grid layout featuring customer reviews and ratings.
 *
 * @package    deltra
 */
...
<!-- wp:group {"metadata":{"name":"Voice of Customers - Grid"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|xx-large","bottom":"var:preset|spacing|xx-large"}}},"layout":{"type":"constrained"}} -->
