<?php
/**
 * Title: Testimonials Featured Grid
 * Slug: deltra/testimonials-featured-grid
 * Categories: testimonials
 * Description: A testimonials grid with one large featured testimonial and three smaller ones, plus brand logos.
 * Viewport Width: 1400
 *
 * @package    deltra
 */
...
<!-- wp:group {"metadata":{"name":"Testimonials Featured Grid"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|giant","bottom":"var:preset|spacing|giant"},"blockGap":"var:preset|spacing|medium"}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group alignwide"><!-- wp:group {"metadata":{"name":"Featured"},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","right":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large","left":"var:preset|spacing|x-large"},"blockGap":"var:preset|spacing|medium"},"border":{"radius":"8px","width":"1px"}},"borderColor":"accent-7","layout":{"type":"constrained"}} -->
...
<div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|large","right":"var:preset|spacing|large","bottom":"var:preset|spacing|large","left":"var:preset|spacing|large"},"blockGap":"var:preset|spacing|medium"},"border":{"radius":"8px","width":"1px"}},"borderColor":"accent-7","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-border-color has-accent-7-border-color" style="border-width:1px;border-radius:8px;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"114px","sizeSlug":"large","linkDestination":"none","className":"is-resized"} -->
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/icons/stars.webp" alt="<?php esc_attr_e( '5 star rating', 'deltra' ); ?>" style="width:114px"/></figure>
<!-- /wp:image -->
...
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|accent-5"}}}},"textColor":"accent-5","className":"has-x-small-font-size"} -->
<p class="has-x-small-font-size has-accent-5-color has-text-color has-link-color"><?php esc_html_e( 'Founder, StartupLab', 'deltra' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|accent-5"}}}},"textColor":"accent-5","className":"has-x-small-font-size"} -->
<p class="has-x-small-font-size has-accent-5-color has-text-color has-link-color"><?php esc_html_e( 'Marketing Director', 'deltra' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|accent-5"}}}},"textColor":"accent-5","className":"has-x-small-font-size"} -->
<p class="has-x-small-font-size has-accent-5-color has-text-color has-link-color"><?php esc_html_e( 'Operations Manager', 'deltra' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<figure class="wp-block-image size-large is-resized has-custom-border is-style-default"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/deltra.png" alt="<?php esc_attr_e( 'Brand logo', 'deltra' ); ?>" style="border-radius:0px;width:150px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
