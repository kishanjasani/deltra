<?php
/**
 * Title: Testimonials Single Dark
 * Slug: deltra/testimonials-single-dark
 * Categories: testimonials
 * Description: A dark-themed single large testimonial with image, star rating, and customer details in a two-column layout.
 * Viewport Width: 1400
 *
 * @package    deltra
 */
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|giant","bottom":"var:preset|spacing|giant"}},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"backgroundColor":"contrast","textColor":"base","layout":{"type":"constrained"},"metadata":{"name":"Testimonials Single Dark"}} -->
...
<!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","right":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large","left":"var:preset|spacing|x-large"},"blockGap":"var:preset|spacing|medium"},"border":{"radius":"8px","width":"1px"}},"borderColor":"accent-4","layout":{"type":"constrained"}} -->
